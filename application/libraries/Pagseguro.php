...
//                throw new Exception("CURL can't connect: $errorMessage");
    ...
    private function get_form_open(){
        $f = array();
        $f[] = '<form id="form_pagseguro" method="post" action="https://sandbox.pagseguro.uol.com.br/v2/checkout/payment.html">';
        // '<!-- Campos obrigatórios -->';
    ...
    private function get_form_close(){
        ...
        $f[] = '<input hidden type="button" class="btn-pagseuro" name="submit1" src="'.$this->button.'" alt="Pague com PagSeguro">';
        $f[] = '</form>';
        return implode("\n", $f);
    }
